  ...
  public ModuleIOTalonFX(int index) {
    switch (index) {
      case 0: // front left
        ...
        driveTalon = new TalonFX(Constants.CAN.FRONT_LEFT_DRIVE);
        turnTalon = new TalonFX(Constants.CAN.FRONT_LEFT_PIVOT);
        cancoder = new CANcoder(Constants.CAN.FRONT_LEFT_ENCODER);
        absoluteEncoderOffset = new Rotation2d(ModuleConstants.MODULE_ZERO_ENCODER_OFFSET); 
        break;
      case 1: // front right
        turnGearRatio = kTURN_GEAR_RATIO_FRONT;
        driveTalon = new TalonFX(Constants.CAN.FRONT_RIGHT_DRIVE);
        turnTalon = new TalonFX(Constants.CAN.FRONT_RIGHT_PIVOT);
        cancoder = new CANcoder(Constants.CAN.FRONT_RIGHT_ENCODER);
        absoluteEncoderOffset = new Rotation2d(ModuleConstants.MODULE_ONE_ENCODER_OFFSET); 
        break;
      case 2: // back left
        turnGearRatio = kTURN_GEAR_RATIO_REAR;
        driveTalon = new TalonFX(Constants.CAN.BACK_LEFT_DRIVE);
        turnTalon = new TalonFX(Constants.CAN.BACK_LEFT_PIVOT);
        cancoder = new CANcoder(Constants.CAN.BACK_LEFT_ENCODER);
        absoluteEncoderOffset = new Rotation2d(ModuleConstants.MODULE_TWO_ENCODER_OFFSET); 
        break;
      case 3: // back right
        turnGearRatio = kTURN_GEAR_RATIO_REAR;
        driveTalon = new TalonFX(Constants.CAN.BACK_RIGHT_DRIVE);
        turnTalon = new TalonFX(Constants.CAN.BACK_RIGHT_PIVOT);
        cancoder = new CANcoder(Constants.CAN.BACK_RIGHT_ENCODER);
        absoluteEncoderOffset = new Rotation2d(ModuleConstants.MODULE_THREE_ENCODER_OFFSET); 
        break;
      default:
